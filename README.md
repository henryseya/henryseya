...
QA Automation Engineer with 5+ years of experience designing and implementing E2E automation frameworks for web, mobile, and API testing (REST and GraphQL).

Ingeniero de QA Automation con más de 5 años de experiencia diseñando e implementando frameworks de automatización E2E para pruebas web, móviles y de APIs (REST y GraphQL).
